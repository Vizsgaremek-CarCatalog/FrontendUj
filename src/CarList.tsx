...
const CarList: React.FC<CarListProps> = ({ isLoggedIn }) => {
  ...
  const handleCloseModal = () => {
    ...
    setTimeout(() => setResetComparison(false), 0);
  };
  ...
  return (
    <div className="min-h-screen w-screen bg-gray-100 dark:bg-gray-900 p-0 m-0">
      <div className="w-full p-6">
              ...
              <div key={car.id} className="relative">
                ...
                {isLoggedIn && (
                  <button
                    ...
                    className="absolute top-2 right-2 px-3 py-1 bg-blue-500 dark:bg-blue-600 text-white dark:text-gray-200 rounded-lg hover:bg-blue-600 dark:hover:bg-blue-700 transition-colors duration-200"
                  >
                    Add to Favorites
                  </button>
                )}
        ...
        <ComparisonModal selectedCars={selectedCarsForComparison} onClose={handleCloseModal} />
      </div>
      <Footer />
    </div>
  );
